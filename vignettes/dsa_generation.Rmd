...
In order to perform a DSA in `dampack`, the user must input the code for the decision analytic model in a standardized format that is compatible with the functions `run_owsa_det`, `run_twsa_det`, and `run_psa`.
