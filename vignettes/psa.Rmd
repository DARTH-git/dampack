...
The probabilistic sensitivity analysis object is a key part of the `dampack` package. In this vignette, we discuss the goals of a probabilistic sensitivity analysis, how to create the `dampack` PSA object from an existing PSA, and what can be done once the PSA object is created in `dampack`.
