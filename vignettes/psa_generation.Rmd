...
# Probablistic Sensitivty Analysis Generation

## Decision Model Format

In order to generate a PSA in `dampack`, the user must input the code for the decision analytic model in a standardized format that is compatible with the `run_psa` function.
...
## Generating Parameter Samples for PSA
...
l_params_basecase <- list(u_D = 0, c_D = 0, d_e = 0.03, d_c = 0.03,
                          p_HS1 = NA, p_S1H = NA, p_S1S2 = NA, p_HD = NA,
                          hr_S1 = NA, hr_S2 = NA, c_H = NA, c_S1 = NA,
                          c_S2 = NA, c_Trt = NA, u_H = NA, u_S1 = NA, u_S2 = NA,
                          u_Trt = NA)
